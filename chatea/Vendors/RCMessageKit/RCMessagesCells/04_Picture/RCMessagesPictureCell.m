...
//    RCMessage *rcmessage = [messagesView rcmessage:indexPath];
	...
	self.viewBubble.backgroundColor = self.rcmessage.incoming ? [RCMessages pictureBubbleColorIncoming] : [RCMessages pictureBubbleColorOutgoing];
	...
	{
		imageView.image = self.rcmessage.picture_image;
