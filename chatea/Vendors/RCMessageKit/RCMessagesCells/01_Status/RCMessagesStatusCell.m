...
//    CGFloat xBubble = (SCREEN_WIDTH - size.width) / 2;
    CGFloat xBubble = (self.contentView.frame.size.width - size.width) / 2;
...
//    CGFloat maxwidth = (0.95 * SCREEN_WIDTH) - [RCMessages statusInsetLeft] - [RCMessages statusInsetRight];
    CGFloat maxwidth = (0.95 * messagesView.view.frame.size.width) - [RCMessages statusInsetLeft] - [RCMessages statusInsetRight];
