...
//    RCMessage *rcmessage = [messagesView rcmessage:indexPath];
    ...
    textView.textColor = [UIColor darkTextColor]; //rcmessage.incoming ? [RCMessages textTextColorIncoming] : [RCMessages textTextColorOutgoing];
...
//    CGFloat maxwidth = (0.6 * SCREEN_WIDTH) - [RCMessages textInsetLeft] - [RCMessages textInsetRight];
    CGFloat maxwidth = (0.6 * messagesView.view.frame.size.width) - [RCMessages textInsetLeft] - [RCMessages textInsetRight];
