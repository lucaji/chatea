...
//    RCMessage *rcmessage = [messagesView rcmessage:indexPath];
	...
	self.viewBubble.backgroundColor = self.rcmessage.incoming ? [RCMessages emojiBubbleColorIncoming] : [RCMessages emojiBubbleColorOutgoing];
	...
	textView.text = self.rcmessage.text;
...
//    CGFloat maxwidth = (0.6 * SCREEN_WIDTH) - [RCMessages emojiInsetLeft] - [RCMessages emojiInsetRight];
    CGFloat maxwidth = (0.6 * messagesView.tableView.frame.size.width) - [RCMessages emojiInsetLeft] - [RCMessages emojiInsetRight];
