...

{
    ...
    self.chatBackgroundColor = [UIColor blackColor];
	...
	self.statusFont						= [UIFont italicSystemFontOfSize:12];
    ...
    self.textBubbleColorOutgoing		= [UIColor colorWithRed:0.54 green:0.90 blue:0.07 alpha:1.0];// HEXCOLOR(0x007AFFFF);
    self.textBubbleColorIncoming		= [UIColor colorWithRed:1.0 green:0.79 blue:0.00 alpha:1.0]; //HEXCOLOR(0xE6E5EAFF);
	self.textTextColorOutgoing			= [UIColor blackColor];
	...
	self.inputViewBackColor				= [UIColor blackColor];
	self.inputTextBackColor				= [UIColor darkTextColor];
	self.inputTextTextColor				= [UIColor whiteColor];
...
+ (UIColor *)chatBackgroundColor				{	return [self shared].chatBackgroundColor;				}
